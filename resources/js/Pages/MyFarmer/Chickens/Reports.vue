...
const fetchReports = async () => {
    ...
    try {
        ...
        console.log("Revenue", charts.value.revenue)

console.log("Expenses", charts.value.expenses)

console.log("Mortality", charts.value.mortality)

console.log("Sales Batch", charts.value.salesByBatch)
...
const revenueSeries = computed(() => [

    {
        ...
        data: charts.value.revenue.map(item => Number(item.revenue))
...
const revenueOptions = computed(() => ({
    ...
    xaxis:{
        ...
        categories: charts.value.revenue.map(item => item.period)
...
//     charts.value.expenses.map(x => Number(x.total))

// )

const expenseSeries = computed(() =>

    charts.value.expenses.map(item => Number(item.total))
...
const expenseOptions = computed(() => ({
    ...
    labels:
        ...
        charts.value.expenses.map(item => item.item),
...
const mortalitySeries = computed(() => [

    {
        ...
        data:
            ...
            charts.value.mortality.map(item =>

                Number(item.mortality)
...
const salesSeries = computed(() => [

    {
        ...
        data:
            ...
            charts.value.salesByBatch.map(item =>
...
const downloadExcel = () => {
    ...
    axios({
        ...
        link.download = 'Chicken_Report.xlsx'
...
<template>
        ...
        <div class="p-6">
            ...
            <a-card class="mb-6">
                ...
                <div class="flex flex-wrap justify-between items-center gap-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a-select v-model:value="filter" style="width:180px" @change="fetchReports">
                        ...
                        <a-range-picker v-if="filter == 'custom'" v-model:value="customDates" @change="fetchReports" />
                    ...
                    <div class="flex gap-2">
                        ...
                        <a-button type="primary" ghost @click="downloadExcel">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <a-card title="Revenue Trend">
                    ...
                    <apexchart height="350" type="line" :options="revenueOptions" :series="revenueSeries" />

                </a-card>

                <a-card title="Expenses by Category">
                   <apexchart type="pie" height="350" :options="expenseOptions" :series="expenseSeries" />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <a-card title="Mortality by Batch">
                    ...
                    <apexchart height="350" type="bar" :options="mortalityOptions" :series="mortalitySeries" />

                </a-card>

                <a-card title="Sales by Batch">

                    <apexchart height="350" type="bar" :options="{
    ...
    data: charts.salesByBatch.map(x => x.sales)
            ...
            <a-card title="Batch Performance Report" class="mb-8">



                <a-table :loading="loading" :data-source="batchPerformance" :scroll="{
...

    {
        ...
        dataIndex: 'profit'
            ...
            <a-card title="Sales Report" class="mb-8">

                <div class="overflow-x-auto">
                    <a-table :data-source="sales" :scroll="{
...

    {
        ...
        dataIndex: 'total_amount'
            ...
            <a-card title="Expense Report" class="mb-8">

                <div class="overflow-x-auto">
                    <a-table :data-source="expenses" :scroll="{
