...
import {Button,Input,Popconfirm, message,Card, Table, Tooltip, Tag, Space} from 'ant-design-vue';
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="p-6">
            ...
            <Card class="mb-6">
                <div class="flex gap-3">
                    <Input v-model:value="searchTerm" placeholder="Search gallery..." @input="handleSearch">
                        <template #prefix>
                            <SearchOutlined />
                        </template>
                    </Input>
            ...
            <!-- Table -->
            <Card>
                <a-table :columns="columns" :data-source="gallery" :loading="loading" row-key="id" :pagination="{
                    pageSize: 10,
        ...
        <CreateGallery v-model:open="showCreateModal" @created="fetchGallery" />

        <ViewGallery v-model:open="showViewModal" :gallery="selectedGallery" />

        <EditGallery v-model:open="showEditModal" :gallery="selectedGallery" @updated="fetchGallery" />
