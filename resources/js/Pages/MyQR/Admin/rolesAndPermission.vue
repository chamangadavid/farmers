                        ...
                        <a-tabs v-model:activeKey="activeTab">
                            ...
                            <a-tab-pane key="roles" tab="Roles">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <div class="flex gap-2">
                                        <Button type="primary" danger :disabled="selectedRoleIds.length === 0"
                                ...
                                <a-table :dataSource="roles" :columns="[
                                    ...
                                    :pagination="{ pageSize: 10, showSizeChanger: true }" bordered size="middle" />
                            </a-tab-pane>
                            ...
                            <a-tab-pane key="permissions" tab="Permissions">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <Button type="primary" @click="showPermissionModal = true">Create
                                        Permission</Button>
                                </div>

                                <a-table :dataSource="permissions" :columns="[
                                    {
                                ...
                                ]" rowKey="id" :pagination="{ pageSize: 10, showSizeChanger: true }" bordered size="middle" />
                            </a-tab-pane>
