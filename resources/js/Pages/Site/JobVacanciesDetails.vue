...
<div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        ...
        <div class="p-6">
            ...
            <div class="mb-8">
                <h3 class="text-md font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 flex items-center gap-2">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="space-y-1">
                        ...
                        <Input 
                            v-model:value="form.current_position" 
                    ...
                    <div class="space-y-1">
                        ...
                        <Input 
                            v-model:value="form.current_employer" 
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <Upload 
                            :before-upload="(file) => handleFile('cv', file)" 
                            :show-upload-list="true" 
                            accept=".pdf" 
                            :max-count="1"
                            :file-list="fileLists.cv"
                            @remove="() => handleRemove('cv')"
                    ...
                    <div class="space-y-2">
                        ...
                        <Upload 
                            :before-upload="(file) => handleFile('nrc', file)" 
                            :show-upload-list="true" 
                            accept=".pdf" 
                            :max-count="1"
                            :file-list="fileLists.nrc"
                            @remove="() => handleRemove('nrc')"
                            class="upload-component"
                        >
                            <Button class="border-teal-600 text-teal-600 hover:bg-teal-50 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <Upload 
                            :before-upload="(file) => handleFile('grade12', file)" 
                            :show-upload-list="true" 
                            accept=".pdf" 
                            :max-count="1"
                            :file-list="fileLists.grade12"
                            @remove="() => handleRemove('grade12')"
                            class="upload-component"
                        >
                            <Button class="border-teal-600 text-teal-600 hover:bg-teal-50 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <Upload 
                            :before-upload="(file) => handleFile('degree', file)" 
                            :show-upload-list="true" 
                            accept=".pdf" 
                            :max-count="1"
                            :file-list="fileLists.degree"
                            @remove="() => handleRemove('degree')"
                            class="upload-component"
                        >
                            <Button class="border-gray-300 text-gray-700 hover:border-teal-600 hover:text-teal-600 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <Upload 
                            :before-upload="(file) => handleFile('masters', file)" 
                            :show-upload-list="true" 
                            accept=".pdf" 
                            :max-count="1"
                            :file-list="fileLists.masters"
                            @remove="() => handleRemove('masters')"
                            class="upload-component"
                        >
                            <Button class="border-gray-300 text-gray-700 hover:border-teal-600 hover:text-teal-600 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <Upload 
                            :before-upload="(file) => handleFile('other', file)" 
                            :show-upload-list="true" 
                            accept=".pdf" 
                            :max-count="1"
                            :file-list="fileLists.other"
                            @remove="() => handleRemove('other')"
                            class="upload-component"
                        >
                            <Button class="border-gray-300 text-gray-700 hover:border-teal-600 hover:text-teal-600 rounded-lg">
            ...
            <div class="mt-8 pt-4 border-t border-gray-200">
                ...
                >
                    <svg v-if="!submitting" class="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
