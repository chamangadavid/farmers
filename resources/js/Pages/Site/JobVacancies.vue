...
const documents = computed(() => [
  { 
    ...
    file: props.application?.cv || null, 
    required: true, 
    icon: '📄' 
  },
  { 
    ...
    file: props.application?.nrc || null, 
    required: true, 
    icon: '🆔' 
  },
  { 
    ...
    file: props.application?.grade12 || null, 
    required: true, 
    icon: '🎓' 
  },
  { 
    ...
    file: props.application?.degree || null, 
    required: false, 
    icon: '📜' 
  },
  { 
    ...
    file: props.application?.masters || null, 
    required: false, 
    icon: '🏆' 
  },
  { 
    ...
    file: props.application?.other_documents || null, 
    required: false, 
    icon: '📁' 
  },
]);
...
<template>
  <Modal 
    ...
    class="application-details-modal"
    :maskClosable="false"
  >
      ...
      <div>
        ...
        <div v-if="hasDocuments" class="space-y-3">
          <div v-for="doc in documents" :key="doc.key" 
               v-if="doc.file && doc.file !== null && doc.file !== ''"
