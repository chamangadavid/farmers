...
const goToDetails = (job) => {
    router.visit(`/all-jobs-details/${job.id}`);
};
        ...
        <template #hero>
            <div class="text-center mt-12">
                ...
                <p class="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto mb-6">
                    Discover exciting job vacancies and take the next step in your career with a leading aviation safety
        ...
        <div class="space-y-8">
                        ...
                        <div v-for="job in filteredJobs" :key="job.id"
                            ...
                            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                                <div class="flex-1">
                                    ...
                                    <h3
                                        class="text-xl font-semibold text-gray-900 mb-2 hover:text-teal-600 transition-colors">
                                        {{ job.title }}
                                    </h3>
                                ...
                                <div class="flex flex-col gap-2 min-w-[140px]">
                                    ...
                                    <a v-if="job.pdf_url" :href="job.pdf_url" target="_blank" rel="noopener noreferrer"
            ...
            <section id="benefits" class="scroll-mt-24 pt-8 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div
                        class="benefit-card text-center p-6 rounded-xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 hover:shadow-lg transition-all duration-300">
                    ...
                    <div
                        ...
                        <p class="text-gray-600 text-sm">Continuous learning, training programs, and career advancement
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-gray-600 text-sm">Health, dental, and retirement plans for you and your family
                        </p>
                    </div>
                </div>
            </section>
