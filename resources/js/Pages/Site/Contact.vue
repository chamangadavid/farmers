        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">AAIB Headquarters<br>Aviation Safety Center<br>Lusaka, Zambia</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">+260 211 123456<br>+260 211 789012</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">info@aaib.gov.zm<br>reports@aaib.gov.zm</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <form class="space-y-4">
                    ...
                    <button 
                        type="submit"
                        class="w-full py-3 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white rounded-lg font-semibold transition-all duration-300"
                    >
                        Send Message
                    </button>
                </form>
