        ...
        <div class="min-h-screen flex items-center justify-center bg-white">
            <div class="w-full h-screen bg-white shadow-xl rounded-2xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="hidden md:block md:w-1/2 bg-gray-100">
                    <img src="/assets/one.png" alt="Reset Password" class="w-full h-full object-cover" />
                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        <div>
                            ...
                            <TextInput id="email" type="email"
                                class="mt-1 block w-full border border-gray-300 rounded-md p-2" v-model="form.email"
